...
- **Initial setup** — клонирование репо, конфигурация ENV-переменных (`STATICBIT_MCP_BEARER`, `XRPL_NETWORK_MAINNET_URL`, etc.).
...
- **Hardening** — systemd unit, bearer-auth для MCP-вызовов, rate-limit per IP/token (см. [features.md §5](docs/features.ru.md#5-server-инфраструктура)).
