...
| Plugin | Tools |
|---|---|
| **xrpl-cloud** | `xrpl_signer_list_set_prepare`, `xrpl_account_set_prepare` (for DisableMaster), `xrpl_payment_prepare` (or any other write), `xrpl_signer_list_status`, `xrpl_tx_preflight`, `xrpl_tx_submit_signed` |
